      ...
      <div className="flex flex-row col-span-6 col-start-1 row-span-2 row-end-7 overflow-hidden frosted-blue">
        ...
        <div className="relative flex flex-row items-center w-full p-6 justify-evenly">
          ...
          <div className="flex flex-col flex-1 h-full">
            <div className="mb-6 text-3xl text-center text-white uppercase">
              {!!activeExpression[0].selectedExpression && (
                <>{activeExpression[0].selectedExpression} stats</>
              )}
            </div>
          ...
          <div className="flex flex-col flex-1 h-full">
            <div className="mb-6 text-3xl text-center text-white uppercase">
              {!!activeExpression[1].selectedExpression && (
                <>{activeExpression[1].selectedExpression} stats</>
              )}
            </div>
            ...
            <div className="flex flex-row flex-1 w-full">
              <div className="flex flex-col items-center w-1/3 text-center">
                ...
                activeExpression[1].selectedExpression == undefined ? (
                  ...
                  <h1
                    className="pt-6 text-5xl text-white"
                    style={textGlowGreen}
                  >
                    {Math.round(
