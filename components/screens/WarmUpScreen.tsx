...
export default function WarmUpScreen(props: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="place-self-center col-span-3 col-start-3 row-span-4 row-start-2">
      ...
      <div className="place-self-center col-span-3 col-start-8 row-span-4 row-start-2">
        <div className="w-64 mx-auto mb-6">
          <PlayerFace
