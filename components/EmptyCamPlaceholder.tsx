...
const blueGlow = (
  ...
  >
    <g filter="url(#filter0_ddd)">
      <path
        d="M55 742C76.8754 654.195 115.186 623.663 230.871 603.087C282.178 597.86 303.398 586.632 327.903 551.94V479.003C279.988 446.933 256.355 422.028 230.871 341.906C205.168 314.012 207.27 298.376 230.871 270.482C241.639 140.391 293.639 55 402.8 55C511.961 55 575.852 139.969 578.671 270.482C602.422 301.007 599.316 316.302 578.671 341.906C553.921 413.251 535.172 444.83 488.916 479.003V551.94C513.006 591.697 539.617 599.637 596.865 603.087C713.665 621.183 738.179 659.228 760 742"
        stroke="white"
        stroke-width="10"
    ...
    <defs>
      ...
      >
        ...
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.294118 0 0 0 0 0.980392 0 0 0 0 0.941176 0 0 0 1 0"
        />
        <feBlend
          mode="normal"
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.52549 0 0 0 0 0.894118 0 0 0 0 0.0352941 0 0 0 1 0"
        />
        <feBlend
          mode="normal"
          in2="BackgroundImageFix"
...
export default function EmptyCamPlaceholder(props) {
  //const returnedEmpty = props.player == 1 ? blueGlow : greenGlow;
  return (
    <svg
      style={{
        width: "90%",
